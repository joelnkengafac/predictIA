...
from .utils import generer_mot_de_passe_temporaire
...
def creer_utilisateur(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # CORRECTIF : Utilisateur.objects.make_random_password() a été retirée
            # de Django 5.1+ (voir accounts/utils.py) — provoquait un AttributeError
            # qui empêchait toute création d'utilisateur par l'administrateur.
