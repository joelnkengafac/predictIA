...
def tous_roles_required(vue):
    """Accessible à tout utilisateur authentifié, quel que soit son rôle
    métier (Administrateur, Analyste ou Décideur) — équivalent explicite de
    @login_required mais exprimé en termes de rôles pour rester cohérent
    avec le reste du système de permissions et rester correct si un
    quatrième rôle est ajouté un jour.
    """
    return role_required("ADMIN", "ANALYSTE", "DECIDEUR")(vue)
